...
IMAGE_DIR = r'C:\Users\user\OneDrive\图片\dalab-categories-products\home & kitchen'
DB_PATH = 'prisma/dev.db'
STORE_ID = 'cmkvifmt40002tks8r6z5o5hn'  # Dalab
CATEGORY_ID = 'cat_home_kitchen'
...
def upload_to_supabase(image_path: str, product_id: str) -> str:
    ...
    try:
        ...
        # Sanitize folder name for storage path (replace spaces with underscores)
        storage_path = f'home_kitchen/{product_id}{file_ext}'
...
def create_product(conn, product_id: str, title: str, image_url: str):
    ...
    try:
        ...
        """, (product_id, title, f"Home & Kitchen - {title}", image_url, STORE_ID, CATEGORY_ID, 'ACTIVE', 0))
...
def main():
    print("Starting Bulk Home & Kitchen Product Ingestion...\n")
    ...
    for idx, filename in enumerate(image_files, 1):
        product_id = f"hk_{uuid.uuid4().hex[:8]}"
        ...
        # Clean up common prefixes if any specific ones appear, otherwise keep generic cleanup
