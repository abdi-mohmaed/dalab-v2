...
IMAGE_DIR = r'C:\Users\user\OneDrive\图片\dalab-categories-products\home appliances\home-appliance-improved images'
DB_PATH = 'prisma/dev.db'
STORE_ID = 'cmkvifmt40002tks8r6z5o5hn'  # Dalab
CATEGORY_ID = 'cat_08233480'  # Home Appliances
...
def upload_to_supabase(image_path: str, product_id: str) -> str:
    ...
    try:
        ...
        storage_path = f'home-appliances/{product_id}{file_ext}'
...
def create_product(conn, product_id: str, title: str, image_url: str):
    ...
    try:
        ...
        """, (product_id, title, f"Home appliance - {title}", image_url, STORE_ID, CATEGORY_ID, 'ACTIVE', 0))
...
def main():
    print("Starting Bulk Home Appliances Product Ingestion...\n")
    ...
    for idx, filename in enumerate(image_files, 1):
        ...
        product_id = f"home_{uuid.uuid4().hex[:8]}"
