...
CATEGORY_ID = 'cat_3a3817c2'  # Electronics
...
def upload_to_supabase(image_path: str, product_id: str) -> str:
    ...
    try:
        ...
        storage_path = f'electronics/{product_id}{file_ext}'
...
def create_product(conn, product_id: str, title: str, image_url: str):
    ...
    try:
        ...
        """, (product_id, title, f"Electronics product - {title}", image_url, STORE_ID, CATEGORY_ID, 'ACTIVE', 0))
...
def main():
    print("Starting Bulk Electronics Product Ingestion...\n")
    ...
    for idx, filename in enumerate(image_files, 1):
        product_id = f"elec_{uuid.uuid4().hex[:8]}"
