...
IMAGE_DIR = r'C:\Users\user\OneDrive\图片\dalab-categories-products\clothing'
...
def upload_to_supabase(image_path: str, product_id: str) -> str:
    ...
    try:
        ...
        storage_path = f'clothing/{product_id}{file_ext}'
...
def create_product(conn, product_id: str, title: str, image_url: str):
    ...
    try:
        ...
        """, (product_id, title, f"Clothing - {title}", image_url, STORE_ID, CATEGORY_ID, 'ACTIVE', 0))
...
def main():
    print("Starting Bulk Clothing Product Ingestion...\n")
    ...
    for idx, filename in enumerate(image_files, 1):
        product_id = f"clo_{uuid.uuid4().hex[:8]}"
