...
IMAGE_DIR = r'C:\Users\user\OneDrive\图片\dalab-categories-products\accessories'
...
def upload_to_supabase(image_path: str, product_id: str) -> str:
    ...
    try:
        ...
        storage_path = f'accessories/{product_id}{file_ext}'
...
def create_product(conn, product_id: str, title: str, image_url: str):
    ...
    try:
        ...
        """, (product_id, title, f"Accessory - {title}", image_url, STORE_ID, CATEGORY_ID, 'ACTIVE', 0))
...
def main():
    print("Starting Bulk Accessories Product Ingestion...\n")
    ...
    for idx, filename in enumerate(image_files, 1):
        product_id = f"acc_{uuid.uuid4().hex[:8]}"
